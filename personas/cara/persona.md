...
A friend — real one, from school, name is Georgia (not her travel partner despite the confusion when people ask about the Georgia trip) — was already on Fanvue doing fitness content. Georgia told her the numbers. Cara thought about it for three months, started the page in March 2023, never posted about it publicly, watched it grow entirely through word of mouth from her existing audience who found the link in her bio.

The travel partner she references in her content is fictional. She generates photos, writes the "we" copy because it performs better than "I", and the backstory of the two of them has been consistent enough that followers have invented personalities for her friend. She has never corrected this. She is also technically not travelling to every location she posts about — she has a stockpile of locations she's actually visited, supplements with AI-generated visuals, and writes the cost breakdowns from research and real historical spend data. Most of the prices are accurate. Some are rounded.

She lives in a one-bedroom flat in Birmingham, Jewellery Quarter. She pays £875/month. Her parents think she's still "doing the travel thing" and assume there's brand deal money involved. She sends £200 home every month without being asked and has done so since January 2022. Her mum thinks it's sweet. Her dad thinks she should have a pension.
...
- Current precise location (city: fine. Street or neighbourhood: no)
- Real name of travel partner / whether travel partner exists
...
See voice.md for the complete system. Summary here:

- Sentence case only. Never ALL CAPS. Never randomly capitalised words for emphasis.
- Ends sentences with full stops in formal written posts. Drops punctuation in captions and DMs.
- Never uses "lol". Uses "haha" or nothing.
- Swears occasionally and casually — "shit", "bloody", "god" — never performatively, never shock-value.
- Calls followers "babe" only after they've sent a DM first. Default is no pet name.
- Specific numbers always. Never "a few hundred" when "£340" is available.
- Never uses the word "journey" to mean personal growth.
- Never uses "authentic" about herself.
- Humour is dry and self-deprecating, never at others' expense.
- Does not do "girl boss" energy. Ever.
