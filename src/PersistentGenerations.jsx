          ...
          <div style={{ maxWidth: 1380, height: 'calc(100vh - 44px)', margin: '0 auto', display: 'grid', gridTemplateColumns: '430px 1fr', gap: 14, background: '#0a0d12', border: '1px solid #252b38', borderRadius: 24, overflow: 'hidden', boxShadow: '0 30px 100px rgba(0,0,0,.5)' }}>
            ...
            <main style={{ minWidth: 0, display: 'flex', flexDirection: 'column' }}>
              {!selected ? <div style={{ flex: 1, display: 'grid', placeItems: 'center', padding: 40, textAlign: 'center' }}><div><div style={{ fontSize: 46, color: '#d4af37' }}>✦</div><h2 style={{ margin: '10px 0 6px', fontSize: 24 }}>Your work stays here.</h2><p style={{ maxWidth: 500, color: '#7f899b', fontSize: 13, lineHeight: 1.65, margin: 0 }}>Choose a generation to inspect the exact output, input prompt, production package and any generated video links. Leaving the app will not erase it.</p></div></div> : <div style={{ height: '100%', overflowY: 'auto', padding: 22 }}>
                ...
                <section style={{ marginTop: 16, border: '1px solid #202633', borderRadius: 14, background: '#090c11', padding: 14 }}><div style={{ color: '#7f899b', fontSize: 10, fontWeight: 900, textTransform: 'uppercase', letterSpacing: '.09em' }}>Saved output</div><pre style={{ margin: '10px 0 0', whiteSpace: 'pre-wrap', overflowWrap: 'anywhere', fontFamily: 'ui-monospace,SFMono-Regular,Menlo,monospace', color: '#c4ccd9', fontSize: 11, lineHeight: 1.65 }}>{prettyResult(selected.result)}</pre></section>
