...
export default function CanonicalProductionWorkspace(){
  ...
  async function queue(){
    if(!selected){setMessage('Choose a content project first.');return;}
    setBusy(true);setMessage('Creating production job…');
    try{
